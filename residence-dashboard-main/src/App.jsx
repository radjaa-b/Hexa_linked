...
import Communication from "./pages/admin/Messages";
...
/>
        ...
        <Route
          path={ROUTES.SECURITY_INCIDENTS}
          element={
            <ProtectedRoute allowedRoles={[ROLES.SECURITY]}>
              <IncidentLog />
            </ProtectedRoute>
